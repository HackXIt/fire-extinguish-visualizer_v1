  ...
  <div class="wrapper">
    ...
    <div class="footer">
      ...
      <a
        ...
        href="https://unsplash.com/@pecchio?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge"
        target="_blank"
        rel="noopener noreferrer"
        title="Download free do whatever you want high-resolution photos from Tommaso Pecchioli"
      >
...
<style lang="scss">
// TODO Implement CSS Grid for more structured Visualization
.wrapper {
  ...
  color: #2c3e50;
  display: grid;
  grid-template-rows: fit-content 2fr min-content;
